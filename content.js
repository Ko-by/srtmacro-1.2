...
/* 22.05.12
*** 로그인체크 *** */
const URL = 'https://etk.srail.kr/main.do';
//console.log(document.getElementsByTagName('a')[3].text);

//URL 일치여부, 태그안 text '로그인' 확인
if (location.href == URL && document.getElementsByTagName('a')[3].text == '로그인') {
	alert ("로그인 먼저 해주세요!")
...
window.addEventListener('keydown',function(e){
	if(e.keyCode == 27 && e.key == 'Escape'){ //키보드 esc
